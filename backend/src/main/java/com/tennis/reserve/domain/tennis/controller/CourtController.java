...
//    public RsData<List<CourtResponse>> getCourts() {
//        List<CourtResponse> courtList = courtService.getCourts();
//
//        return new RsData<>(
//                "200-4",
//                "테니스장 목록을 조회하였습니다.",
...
//    @Transactional(readOnly = true)
//    @PreAuthorize("hasRole('USER')")
//    public RsData<CourtResponse> getCourt(@PathVariable Long id) {
